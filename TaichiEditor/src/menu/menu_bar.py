...
class MenuBar(QMenuBar):
    ...
    __edit = ("undo", "redo", "compile", "cut", "copy", "paste", "replace_in_file")
    ...
    def __set_file_menu(self):
        ...
        self.master.addToolBar(file_toolbar)
        file_toolbar.addAction(self.bookmarks.FILE["new"])
        file_toolbar.addAction(self.bookmarks.FILE["open_file"])
        file_toolbar.addAction(self.bookmarks.FILE["save"])
        file_toolbar.addAction(self.bookmarks.FILE["save_as"])
    ...
    def __set_edit_menu(self):
        ...
        self.bookmarks.EDIT['compile'].setShortcut("Ctrl+B")
        self.bookmarks.EDIT['compile'].triggered.connect(
            lambda: self.compile.emit())
        ...
        self.master.addToolBar(edit_toolbar)
        edit_toolbar.addAction(self.bookmarks.EDIT["undo"])
        edit_toolbar.addAction(self.bookmarks.EDIT["compile"])
